...
export default function AdminShell({
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      <aside className="fixed left-0 top-0 h-screen w-20 border-r border-white/10 bg-black/50 backdrop-blur-xl print:hidden">
      ...
      <div className="ml-20 print:ml-0">
        <header className="sticky top-0 z-40 border-b border-white/10 bg-neutral-950/80 backdrop-blur-xl print:hidden">
